...
API_Model.confirm_request = (data, cb) => conn.query('INSERT INTO solicitudes (cod_estado_solicitud, cod_usuario_transp, cod_carga, fec_solicitud, patente_camion, patente_carroceria) VALUES ($1, $2, $3, $4, $5, $6)', [data.cod_estado_solicitud, data.cod_usuario_transp, data.cod_carga, data.fec_solicitud, data.patente_camion, data.patente_carroceria], cb)
